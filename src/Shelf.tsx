    ...
    <Box sx={{ width: "100%", height: "100%", bgcolor: c.navy, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <Box sx={{ flexShrink: 0, px: "24px", pt: "15px", pb: "0px" }}>
        <Box sx={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", mb: "8px" }}>
          ...
          {/* Profile avatar */}
          <Box sx={{ width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg, rgb(226,169,201) 0%, rgb(139,169,198) 100%)", opacity: 0.9, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Box sx={{ width: 36, height: 36, borderRadius: "50%", m: "2px", backgroundImage: `url(${paperTexture}), linear-gradient(135deg, #eee9dc 0%, #d3e8e2 100%)`, backgroundSize: "cover, cover", backgroundBlendMode: "multiply", display: "flex", alignItems: "center", justifyContent: "center" }}>
