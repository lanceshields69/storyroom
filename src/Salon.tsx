...
/** StoryBot mark from Figma (node 194:4576 — bot); aspect ~24.43×20; `size` is height in px */
const StorybotIcon = ({ size = 22 }: { size?: number }) => {
  const w = (size * 24.4309) / 20;
  return (
    <Box component="span" sx={{ display: "inline-flex", flexShrink: 0, color: "#ffffff", lineHeight: 0 }}>
      <svg width={w} height={size} viewBox="0 0 24.4309 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path
          d="M8.36712 10.3286C6.72472 10.3286 5.39198 11.6645 5.39198 13.3038C5.39198 14.9431 6.72782 16.2789 8.36712 16.2789C10.0065 16.2789 11.3423 14.9431 11.3423 13.3038C11.3423 11.6645 10.0064 10.3286 8.36712 10.3286ZM8.36712 15.2426C7.29925 15.2426 6.43137 14.3747 6.43137 13.3068C6.43137 12.239 7.29925 11.3711 8.36712 11.3711C9.43499 11.3711 10.3029 12.239 10.3029 13.3068C10.3029 14.3747 9.43499 15.2426 8.36712 15.2426Z"
          fill="currentColor"
        />
        <path
          d="M16.0596 10.3286C14.4172 10.3286 13.0845 11.6645 13.0845 13.3038C13.0845 14.9431 14.4203 16.2789 16.0596 16.2789C17.699 16.2789 19.0347 14.9431 19.0347 13.3038C19.0347 11.6645 17.6989 10.3286 16.0596 10.3286ZM16.0596 15.2426C14.9917 15.2426 14.1239 14.3747 14.1239 13.3068C14.1239 12.239 14.9917 11.3711 16.0596 11.3711C17.1275 11.3711 17.9954 12.239 17.9954 13.3068C17.9954 14.3747 17.1275 15.2426 16.0596 15.2426Z"
          fill="currentColor"
        />
        <path
          d="M23.9071 10.4614H21.3867V10.0767C21.3867 8.16634 19.8326 6.61331 17.9233 6.61331H12.6996V3.77304C13.5076 3.54464 14.1024 2.80363 14.1024 1.92255C14.1024 0.862813 13.2396 0 12.1799 0C11.1201 0 10.2573 0.862813 10.2573 1.92255C10.2573 2.80363 10.8522 3.54363 11.6601 3.77304V6.61331H6.49958C4.5892 6.61331 3.03617 8.1674 3.03617 10.0767V10.4614H0.519789C0.233527 10.4614 6.86198e-05 10.6949 6.86198e-05 10.9812V15.6321C6.86198e-05 15.9184 0.233537 16.1519 0.519789 16.1519H3.04022V16.5366C3.04022 18.447 4.59432 20 6.50364 20H17.9273C19.8377 20 21.3908 18.4459 21.3908 16.5366V16.1519H23.9112C24.1975 16.1519 24.4309 15.9184 24.4309 15.6321V10.9812C24.4309 10.6949 24.1974 10.4614 23.9112 10.4614H23.9071ZM11.2987 1.9227C11.2987 1.43445 11.6966 1.0396 12.1818 1.0396C12.6681 1.0396 13.0649 1.43749 13.0649 1.9227C13.0649 2.40893 12.6671 2.80581 12.1818 2.80581C11.6956 2.80581 11.2987 2.40792 11.2987 1.9227ZM1.03946 15.1127V11.5011H3.04017V15.1127H1.03946ZM20.3473 16.5368C20.3473 17.8727 19.2612 18.9608 17.9233 18.9608H6.50169C5.16585 18.9608 4.07769 17.8747 4.07769 16.5368V10.077C4.07769 8.74115 5.16383 7.65298 6.50169 7.65298H17.9254C19.2612 7.65298 20.3494 8.73912 20.3494 10.077V16.5368H20.3473ZM23.3874 15.1127H21.3867V11.5011H23.3874V15.1127Z"
          fill="currentColor"
        />
      </svg>
    </Box>
